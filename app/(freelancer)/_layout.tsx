...
export default function FreelancerLayout() {
  ...
  return (
    <Drawer
      drawerContent={() => <DrawerContent contracts={contracts} userRole="freelancer" unreadCounts={unreadCounts} notificationUnreadCount={notificationUnreadCount} onSignOut={() => signOut()} />}
    >
      <Drawer.Screen
